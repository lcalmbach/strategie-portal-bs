...
class Planung:
    ...
    def run(self):
        ...
        for organisation_massnahme in organisation_massnahmen:
            for year in range(organisation_massnahme.massnahme.jahr_start, organisation_massnahme.massnahme.jahr_ende + 1):
                ...
                aufwand_personen_tage_plan = massnahme.aufwand_personen_tage_plan / num_years if massnahme.aufwand_personen_tage_plan > 0 else 0
                aufwand_tsd_chf_plan = massnahme.aufwand_tsd_chf_plan / num_years if massnahme.aufwand_tsd_chf_plan > 0 else 0
